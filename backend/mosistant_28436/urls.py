"""mosistant_28436 URL Configuration
...
admin.site.site_header = "Mosistant"
admin.site.site_title = "Mosistant Admin Portal"
admin.site.index_title = "Mosistant Admin"

# swagger
api_info = openapi.Info(
    title="Mosistant API",
    default_version="v1",
    description="API documentation for Mosistant App",
)
